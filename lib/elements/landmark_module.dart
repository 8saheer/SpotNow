  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10.0), // Slight corner radius for the module container
      ),
      child: Column(
        ...
        children: [
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(
                  ...
                  width: double.infinity, // Image takes full width of the container
                  ...
                  loadingBuilder: (context, child, loadingProgress) {
                    ...
                    return Container(
                      ...
                      child: const Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Colors.grey))),
                    );
                  },
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(5.0), // Rounded corners for rating box
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        widget.landmark.overallRating.toStringAsFixed(1), // Format to one decimal place
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 6.0, vertical: 4), // Padding around the text content
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const Icon(
                          Icons.star,
                          color: Colors.blue, // Blue star color
                          size: 16.0,
                        ),
                        const SizedBox(width: 4.0),
                        Text(
                          widget.landmark.recentRating.toStringAsFixed(1), // Format to one decimal place
                          style: const TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.bold,
                            color: Colors.black87,
                ...
                const SizedBox(height: 4.0), // Small space between name/rating and distance
                // Distance
                Text(
